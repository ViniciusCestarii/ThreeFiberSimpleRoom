...
export function Shapes({ isHover, isPress, mouseX, mouseY }) {
  ...
  return (
    <Canvas shadows dpr={[1, 2]} resize={{ scroll: false, offsetSize: true }} className="absolute w-full h-full">
...
export function Lights() {
  return (
    <>
      <spotLight color="#61dafb" position={[-10, -10, -10]} intensity={1000.2} />
      <spotLight color="#61dafb" position={[-10, 0, 15]} intensity={1000.8} />
      <spotLight color="#61dafb" position={[-5, 20, 2]} intensity={1000.5} />
      <spotLight color="#f2056f" position={[15, 10, -2]} intensity={1000} />
      <spotLight color="#f2056f" position={[15, 10, 5]} intensity={1000} />
      <spotLight color="#b107db" position={[5, -10, 5]} intensity={1000.8} />
    </>
  );
}
